...
export const K14_ACTION_DEFINITIONS: Readonly<Record<K14ActionId, K14ActionDefinition>> = Object.freeze({
  ...
  "cai.finance.11.position_update": action("cai.finance.11.position_update", "position-update", [write("update", "PATCH", "/positions/{position_id}")]),
  ...
  "cai.finance.13.position_import_shopping": action("cai.finance.13.position_import_shopping", "position-import-shopping", [write("import", "POST", "/positions/{position_id}/import-shopping-estimate")]),
  ...
  "cai.finance.16.entry_create": action("cai.finance.16.entry_create", "entry-create", [write("create", "POST", "/positions/{position_id}/entries")]),
  "cai.finance.17.entry_show": action("cai.finance.17.entry_show", "entry-show", [read("show", "/entries/{entry_id}")]),
  "cai.finance.18.entry_update": action("cai.finance.18.entry_update", "entry-update", [write("update", "PATCH", "/entries/{entry_id}")]),
  ...
  "cai.finance.20.entry_approve": action("cai.finance.20.entry_approve", "entry-approve", [write("approve", "POST", "/entries/{entry_id}/approve", true)]),
});
