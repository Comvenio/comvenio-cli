...
export const CHAT_GPT_APP_MANIFEST_SCHEMA = z.object({
  ...
  privacy_url: httpsUrl.pipe(z.literal("https://www.comvenio.app/connector/datenschutz")),
  terms_url: httpsUrl.pipe(z.literal("https://www.comvenio.app/connector/nutzungsbedingungen")),
