...
export const RELEASE_GATE_REPORT_SCHEMA = z.object({
  ...
  evidence: z.object({
    action_classification_count: z.number().int().nonnegative(),
    action_total: z.number().int().nonnegative(),
    route_callsite_count: z.number().int().nonnegative(),
    audited_operation_catalog_published: z.boolean(),
    ...
    widget_contract_count: z.number().int().nonnegative(),
